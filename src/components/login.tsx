...
const avatar = <div className="flex justify-center text-amber-500 items-center  text-white  ">
    <Avatar
        size={"sm"}
        icon={<AvatarIcon/>}
        classNames={{
...
const passwordContent = <div className="flex justify-center text-amber-500 items-center  text-white  ">
    <Avatar
        size={"sm"}
        icon={<RiLockPasswordFill className="w-5 h-5 text-amber-500"/>}
        classNames={{
            base: "bg-transparent ",
            icon: "text-white",
...
function Login() {
    ...
    return (
        <div className={"h-screen bg-gray-950 flex justify-center items-center  text-white"}>
            <form onSubmit={handleSubmit} className="w-full flex justify-center">
                <div
                    className={" gap-y-5 px-5 border-8 border-slate-800 bg-gray-900 rounded-2xl  py-5  " +
                        "w-1/4 h-auto flex justify-center items-center flex-col shadow-xl shadow-black"}>
                    <div className={"flex items-center gap-x-3 "}>
                        <Image
                            ...
                            height={75}
                            quality={100}
                            alt="Logo of Rising Digital"
                        />
                        <span className="text-4xl ">|</span>
                        <p className="font-semibold text-2xl text-center text-amber-500 font-black ">Rising Digital </p>
                    </div>
                    <p className="font-bold text-lg text-center">Sign in to your account</p>
                    <Input size={"sm"}
                    ...
                    <Input
                        ...
                        disabled={username.trim() !== "" && username.length > 0 ? false : true}
                        endContent={
                    ...
                    <p onClick={onOpen} className="hover:cursor-pointer w-full text-end text-xs underline">Forgot password ?</p>
                    <Button type={"submit"}
                            isLoading={goDashboard ? true : false}
                            className="bg-amber-500 w-full text-white font-bold  text-lg">
                        Login
                    </Button>
                    <Modal backdrop={"blur"} isOpen={isOpen} classNames={{
                        body: "py-6",
